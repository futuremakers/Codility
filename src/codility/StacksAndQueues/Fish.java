 ...
 * > A[P] then Q eats P, and Q will still be flowing upstream.
 * 
 ...
 * 
 * For example, consider arrays A and B such that: A[0] = 4 B[0] = 0 A[1] = 3
 * B[1] = 1 A[2] = 2 B[2] = 0 A[3] = 1 B[3] = 0 A[4] = 5 B[4] = 0
 * 
