...
/**
 * 
 * fibonacci sequence is defined using the following recursive formula:
 *     F(0) = 0
 *     F(1) = 1
 ...
 * The frog can jump over any distance F(K), where F(K) is the K-th Fibonacci number. Luckily, there are many leaves on the river, 
 ...
 * that, given a zero-indexed array A consisting of N integers, returns the minimum number of jumps by which the frog can get to the other side of 
 * the river. If the frog cannot reach the other side of the river, the function should return −1.
 * For example, given:
 *     A[0] = 0
 *     A[1] = 0
 *     A[2] = 0
